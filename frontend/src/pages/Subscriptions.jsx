  ...
  try{
    ...
    if(planForm.id){
      ...
      await api.put(
        ...
        `/subscription-plans/${planForm.id}`,
...
/* ============================================================
   ...
   Loads a selected plan into the form.
============================================================ */
  ...
  try{
    ...
    if(promoForm.id){
      ...
      setMessage(
        ...
        "Promo campaign updated successfully."
      ...
      setMessage(
        ...
        "Promo campaign created successfully."
...
async function deletePromo(id){
  ...
  try{
    ...
    setError(
      ...
      "Unable to delete promo campaign."
...
<div className="container-fluid py-4">
            ...
            <input
              ...
              onChange={(e)=>
                ...
                setPlanForm({
                  ...
                  half_yearly_price:e.target.value
  ...
  {/* ============================================================
      FREE SCHOOLS / SPECIAL ACCESS
      This section allows DONO ADMIN to:
      - Give any school FREE access
      - Override subscription
      - Grant lifetime access
      - Give temporary access
      ============================================================ */}

  {activeTab === "freeSchools" && (
