...
class UpdateStaffRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'staff_number' => 'sometimes|required|string|max:50|unique:staff,staff_number,' . $staffId,
            ...
            'employment_status' => 'sometimes|required|in:Active,Suspended,Retired,Resigned,Terminated',
        ];
    }
