...
class UpdateExamScoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'class_subject_id' => 'sometimes|required|exists:class_subject,id',

            'examination_id' => 'sometimes|required|exists:examinations,id',

            'ca_score' => 'sometimes|required|numeric|min:0|max:100',

            'exam_score' => 'sometimes|required|numeric|min:0|max:100',

            'total_score' => 'sometimes|required|numeric|min:0|max:100',
